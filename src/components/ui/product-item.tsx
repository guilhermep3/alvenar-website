...
export const ProductItem = ({ product }: props) => {
   ...
   return (
      <div data-aos="fade-up" className="cardProduct group relative flex flex-col gap-2 p-4 rounded-xl overflow-hidden w-fit bg-white text-black shadow-lg z-10 border border-zinc-300 cursor-pointer">
